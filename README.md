...
完整产品演示视频已经发布，建议先看视频再结合 README 和示例报告快速理解项目能力。

> **Watch the demo:** [Bilibili · CodeLens AI PR Review Assistant 演示视频](https://www.bilibili.com/video/BV1gbVU6REfr/?share_source=copy_web&vd_source=71585f0de29ffc0374528a16fd53f4db)

仓库内也保留了一个独立视频入口页：[`docs/demo-video.md`](./docs/demo-video.md)
...
- Demo 演示视频：[`docs/demo-video.md`](./docs/demo-video.md)
- 视频讲解脚本：[`docs/demo-script.md`](./docs/demo-script.md)

如果你想快速理解这个项目最终会输出什么，建议先看演示视频，再看示例报告。前者帮助快速建立整体印象，后者能更清楚地展示最终输出结构。
